...
export const Home = () => {
    ...
    return <MainLayout>
            <div className="flex justify-center items-center">
                <div className="flex flex-col md:flex-row h-full justify-center align-middle max-w-5xl p-12 gap-16">
                    <div className="flex flex-col flex-1 align-middle justify-center gap-6 md:w-1/2 text-white">
                    ...
                    <img src={IMG} className="md:w-1/2 flex-1 w-[1600px]" alt="Smart Camps Illustration" />
                </div>
            </div>
    </MainLayout>
}
